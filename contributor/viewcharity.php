...
<?php
session_start();
$img=$_SESSION["image_src"];
echo $img." helllllllllo";
       ...
       <div class="navbar">
              <div class="left">
                     <div class="Logo">
                            ...
                            <!-- <img src="" alt="logo" class="foodablelogo" /> -->
                     </div>
              ...
              <div class="right">
                     <div class="Profilephoto">
                            <!-- <img src="../images/blank-profile-picture-973460__340.png" alt="PRofile photo" width="60px"
                                   height="60px"> -->
       ...
       <div class="cardsection">
              <div class="Cards">
                     ...
                     for ($i = 0; $i < count($grouparr); $i++) {
                            ...
                            <div class="img">
                            <img src="<?php echo "../upload_charity/".$grouparr[$i][6]; ?>" alt="Card Image"  width="250" height="250"/>
                            </div>
                                   <h3>
